...
-- data needed cleaning (dropped code cells, note rows, embedded footnotes).
...
--
-- Codes the CBDS sheet dropped from well-established sets are reconstructed from
-- the DfE framework; a few brand-new reasons the sheet lists without a code keep
-- a NULL Code rather than a guessed one. SenProvisionTypes is intentionally NOT
-- reseeded: the CBDS "Pupil SEN Provision" set is SEN *stage* (No SEN / SEN
-- support / EHC plan), which maps to our SenStatus table, not to the
-- provision-service catalogue this table holds.
-- ============================================================================
...
MERGE INTO [dbo].[EnrolmentStatus] AS Target
    ...
    (N'7848D164-EE36-3816-408A-7ECB32F680D7', N'Guest (pupil not registered at this school but attending some lessons or sessions)', NULL, 0),
...
GO
UPDATE [dbo].[EnrolmentStatus] SET [Active] = 0 WHERE [Id] NOT IN (SELECT [Id] FROM (VALUES (N'5EAD4545-C006-1C1A-EB86-49AFC23F6EE1'),(N'B77E95B0-8F93-06E8-A14B-050AFE215947'),(N'832ABE83-BC93-715C-F534-528AB329C3E7'),(N'B77F4F42-34EF-773F-228A-311AF49CC0CD'),(N'E597284A-2E12-AF45-22A7-F5D7BE60DCCC'),(N'7848D164-EE36-3816-408A-7ECB32F680D7'),(N'A236B72E-D1B4-57EB-07E2-81FABEF8D544')) v([Id]));
GO
...
GO
UPDATE [dbo].[ExclusionTypes] SET [Active] = 0 WHERE [Id] NOT IN (SELECT [Id] FROM (VALUES (N'C4AD61E6-3341-B4A5-3F73-3979697BFBB0'),(N'0DEE3EC7-1EDA-653C-387D-81651906A675')) v([Id]));
GO
...
MERGE INTO [dbo].[ExclusionReasons] AS Target
    ...
    (N'2BD1F930-C6DF-3FCE-E25A-E86E7B9692CF', N'Cyber-bullying or threatening behaviour online', NULL, 0, 1),
    ...
    (N'82CD71B4-52B7-2F8C-838A-7643F0D51BD7', N'Harmful sexual behaviour', NULL, 0, 1),
    ...
    (N'5E7C3B79-8FBD-8D1B-C224-6DC832DE95AB', N'Persistent disruptive behaviour - low level disruption', NULL, 0, 1),
    ...
    WHEN MATCHED THEN UPDATE SET Description = Source.Description, Code = Source.Code, DisplayOrder = Source.DisplayOrder, IsSystem = Source.IsSystem, Active = 1;
GO
UPDATE [dbo].[ExclusionReasons] SET [Active] = 0 WHERE [Id] NOT IN (SELECT [Id] FROM (VALUES (N'6D107981-DE1F-A542-C54D-F67B9DE8DE81'),(N'2DECDC79-154B-2300-AF32-9A27090A65C2'),(N'ABCB32AF-611A-7E31-C8B5-F4288B88ED68'),(N'7EBC53E6-74F5-5DE5-9522-C2568EFF5F60'),(N'232612C3-6A14-BA3B-9EE2-33EC94556BBE'),(N'9748C46C-5697-6E37-2A0A-8DC2628E0234'),(N'B301FFF5-51B3-C230-E5B9-5F1745990A30'),(N'2BD1F930-C6DF-3FCE-E25A-E86E7B9692CF'),(N'7BB2FE75-3EFA-77CB-DC91-D93F6CFB1488'),(N'872D8AED-273A-D451-8E1F-699D2F693265'),(N'E3449E7A-3B8D-102B-37AA-E42AE9D32A94'),(N'AA05558C-B922-7671-EE6C-ED840B3529A0'),(N'82CD71B4-52B7-2F8C-838A-7643F0D51BD7'),(N'1CB96A82-CCB8-8146-97B2-92ADB86E9565'),(N'47807374-2F3B-2FAC-CFB9-902928622103'),(N'3B5AC305-B0A6-B168-2039-142C5F56A341'),(N'84788074-AADD-B864-F6B8-386FB5DA96F5'),(N'1126B9D3-307C-C91E-B48F-0285F69C46D0'),(N'6A7C3BB8-0A02-C073-D51A-50B870BDD83A'),(N'936B91E0-C5BA-FE36-71E9-56A95208843D'),(N'C8235387-428F-657D-A807-A1DF05F7AB06'),(N'C793C491-DD04-574D-D0C3-560EEC7A77CD'),(N'5E7C3B79-8FBD-8D1B-C224-6DC832DE95AB'),(N'C7119751-1281-7647-3085-C712A71A262F'),(N'A2B65E91-60C7-CCF7-D775-ACEE76532499'),(N'DADE34B4-F44F-0EDA-730C-820831E677FC'),(N'45F7190B-71F2-E23E-165F-DE68E3B8022B'),(N'F5337DEB-E2D9-7B1A-A60B-CA39B4D92425'),(N'9FC69FAD-786D-DCF2-FD38-E9C4001E6493')) v([Id]));
GO
