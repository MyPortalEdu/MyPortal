...
UPDATE SET Description = Source.Description, JcQualificationCode = Source.JcQualificationCode, Active = Source.Active
    ...
    WHEN NOT MATCHED THEN
INSERT (Id, Description, Active, JcQualificationCode, IsSystem)
...
MERGE INTO [dbo].[ExamQualificationLevels] AS Target
    ...
    WHEN MATCHED THEN UPDATE SET DefaultGradeSetId = Source.DefaultGradeSetId
                          ...
                          WHEN NOT MATCHED THEN
                      INSERT (Id, Description, Active, QualificationId, DefaultGradeSetId, JcLevelCode, IsSystem)
...
MERGE INTO [dbo].[BehaviourOutcomes] AS Target
    ...
    WHEN MATCHED THEN
UPDATE SET Description = Source.Description, Active = Source.Active, IsSystem = Source.System
...
MERGE INTO [dbo].[BehaviourStatus] AS Target
    ...
    WHEN MATCHED THEN
UPDATE SET Description = Source.Description, Active = Source.Active, IsResolved = Source.Resolved

    WHEN NOT MATCHED THEN
INSERT (Id, Description, Active, IsResolved)
...
MERGE INTO [dbo].[ProductTypes] AS Target
    USING (VALUES
    ('9508DB1A-1FC2-44E2-9BB7-E0924A003376', 'Meals'),
    ('9509DB1A-1FC2-44E2-9BB7-E0924A003376', 'Trips'),
    ('950ADB1A-1FC2-44E2-9BB7-E0924A003376', 'Uniform'),
    ('950BDB1A-1FC2-44E2-9BB7-E0924A003376', 'Stationery'),
    ('950CDB1A-1FC2-44E2-9BB7-E0924A003376', 'Books')
    )
    AS Source (Id, Description)
    ON Target.Id = Source.Id
...
MERGE INTO [dbo].[TaskTypes] AS Target
    ...
    WHEN NOT MATCHED THEN
    INSERT (Id, Description, Active, IsPersonal, ColourCode, IsSystem)
...
MERGE INTO [dbo].[ExclusionTypes] AS Target
    ...
    WHEN NOT MATCHED THEN
    INSERT (Id, Code, Description, Active, IsSystem)
...
MERGE INTO [dbo].[AgencyTypes] AS Target
    ...
    AS Source (Id, Description, Active, IsSystem)
    ON Target.Id = Source.Id

    WHEN NOT MATCHED THEN
    INSERT (Id, Description, Active, IsSystem)
    VALUES (Id, Description, Active, IsSystem);
