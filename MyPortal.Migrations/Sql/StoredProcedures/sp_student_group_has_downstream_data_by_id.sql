...
-- Mirrors the AY-level downstream check (sp_academic_year_has_downstream_data_by_id)
-- but scoped to a single group.
CREATE OR ALTER PROCEDURE [dbo].[sp_student_group_has_downstream_data_by_id]
