...
-- lives in the service layer for parity with usp_register_submit.
CREATE OR ALTER PROCEDURE [dbo].[usp_attendance_marks_submit_bulk]
...
BEGIN
    ...
    -- Roster (regular + extras), same shape as usp_attendance_marks_get_bulk.
