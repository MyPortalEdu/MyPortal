...
describe('BulletinsDataService', () => {
  ...
  it('list() GETs /api/bulletins with page+pageSize query', () => {
    ...
    const req = http.expectOne(r => r.url === '/api/bulletins' && r.method === 'GET');
  ...
  it('list() defaults to page 1, pageSize 25', () => {
    ...
    const req = http.expectOne(r => r.url === '/api/bulletins');
  ...
  it('getById() GETs /api/bulletins/{id}', () => {
    ...
    const req = http.expectOne('/api/bulletins/b1');
  ...
  it('create() POSTs /api/bulletins with the model body', () => {
    ...
    const req = http.expectOne('/api/bulletins');
  ...
  it('pin() PUTs /api/bulletins/{id}/pin', () => {
    ...
    const req = http.expectOne('/api/bulletins/b1/pin');
    expect(req.request.method).toBe('PUT');
    expect(req.request.body).toEqual(model);
    req.flush(null);
  });
  ...
  it('acknowledge() POSTs /api/bulletins/{id}/acknowledge with an empty body', () => {
    ...
    const req = http.expectOne('/api/bulletins/b1/acknowledge');
    expect(req.request.method).toBe('POST');
  ...
  it('listCategories(false) caches the active-only response across subscribers', () => {
    ...
    const first = http.expectOne(r => r.url === '/api/bulletincategories' && !r.params.has('includeInactive'));
    ...
    http.expectNone('/api/bulletincategories');
  ...
  it('listCategories(true) bypasses the cache and adds includeInactive=true', () => {
    ...
    const req = http.expectOne(r => r.url === '/api/bulletincategories');
  ...
  it('createCategory() POSTs and invalidates the active-categories cache', () => {
    ...
    http.expectOne('/api/bulletincategories').flush([]);
    ...
    const post = http.expectOne('/api/bulletincategories');
  ...
  it('updateCategory() PUTs and invalidates the active-categories cache', () => {
    ...
    const put = http.expectOne('/api/bulletincategories/c1');
    expect(put.request.method).toBe('PUT');
    put.flush(null);

    service.listCategories().subscribe();
    const refetch = http.expectOne('/api/bulletincategories');
  ...
  it('deleteCategory() DELETEs and invalidates the active-categories cache', () => {
    ...
    const del = http.expectOne('/api/bulletincategories/c1');
  ...
  it('getSettings() GETs /api/bulletins/settings', () => {
    ...
    const req = http.expectOne('/api/bulletins/settings');
    expect(req.request.method).toBe('GET');
    req.flush(expected);
  });
