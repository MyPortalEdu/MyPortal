...
/// </summary>
public class StaffAddressService : BaseService, IStaffAddressService
{
    ...
    public StaffAddressService(IAuthorizationService authorizationService, ILogger<StaffAddressService> logger,
    ...
    public async Task<AddressListResponse> GetAddressesAsync(Guid staffMemberId, CancellationToken cancellationToken)
    {
        ...
        return await _personAddressService.GetAddressesAsync(personId, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _personAddressService.SearchAddressesAsync(query, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _personAddressService.AddAddressAsync(personId, model, cancellationToken);
    }
        ...
        PersonAddressUpdateRequest model, CancellationToken cancellationToken)
    {
        ...
        await _personAddressService.UpdateAddressAsync(personId, addressPersonId, model, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _personAddressService.RemoveAddressAsync(personId, addressPersonId, cancellationToken);
    }
