...
public interface ITimetableSolveService
{
    ...
    Task<TimetableRun> QueueRunAsync(Guid timetableId, CancellationToken cancellationToken);
    ...
    Task ExecuteRunAsync(Guid runId, Guid timetableId, CancellationToken cancellationToken);
}
