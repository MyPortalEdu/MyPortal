...
public class StaffContractRepository : EntityRepository<StaffContract>, IStaffContractRepository
{
    public StaffContractRepository(IDbConnectionFactory factory, IAuthorizationService authorizationService) :
