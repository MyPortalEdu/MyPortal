...
public class DbsCheckRepository : EntityRepository<DbsCheck>, IDbsCheckRepository
{
    public DbsCheckRepository(IDbConnectionFactory factory, IAuthorizationService authorizationService) :
        ...
        CancellationToken cancellationToken, IDbTransaction? transaction = null)
    {
        ...
        try
        {
            ...
            return await conn.QueryAsync<DbsCheck>(command);
        }
        finally
        {
            if (owns)
