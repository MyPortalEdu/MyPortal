...
public class AddressRepository(IDbConnectionFactory factory, IAuthorizationService authorizationService)
    : EntityRepository<Address>(factory, authorizationService), IAddressRepository
{
