...
{
    public class RoleRepository(IDbConnectionFactory factory, IAuthorizationService authorizationService)
        : EntityRepository<Role>(factory, authorizationService), IRoleRepository
    {
