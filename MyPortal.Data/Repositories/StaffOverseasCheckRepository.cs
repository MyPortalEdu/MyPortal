...
public class StaffOverseasCheckRepository : EntityRepository<StaffOverseasCheck>, IStaffOverseasCheckRepository
{
    public StaffOverseasCheckRepository(IDbConnectionFactory factory, IAuthorizationService authorizationService) :
        ...
        CancellationToken cancellationToken, IDbTransaction? transaction = null)
    {
        ...
        try
        {
            ...
            return await conn.QueryAsync<StaffOverseasCheck>(command);
        }
        finally
        {
            if (owns)
